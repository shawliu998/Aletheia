...
| Workspace database         | One SQLCipher database with contiguous, checksum-recorded migrations through v26.                                                                                                                                                                                                                         |
...
| Irreversible Agent actions | The v19/v24/v26 action ledger records create-Draft, suggest-Draft-edit, run-Workflow, contract-review, and custom-extraction reservations/completions. Stable semantic identities and durable per-action budgets prevent attempt retries from multiplying Reviews or Drafts.                              |
