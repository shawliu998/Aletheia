...
import { listProjects } from "@/app/lib/aletheiaApi";
import type { Project } from "@/app/components/shared/types";
import { cn } from "@/lib/utils";

const NAV_ITEMS = [
    { href: "/aletheia", label: "Aletheia", icon: Layers3 },
            ...
            >
                {isOpen && (
                    <div className="px-2">
                        ...
                        >
                            <span className="flex h-7 w-7 items-center justify-center rounded-md bg-[#0f3d35] text-white">
