...
(
  ...
  export NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY="${NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY:-demo-anon-key}"
  export NEXT_PUBLIC_ALETHEIA_PRIVATE_AUTH_TOKEN="${NEXT_PUBLIC_ALETHEIA_PRIVATE_AUTH_TOKEN:-}"
  npm run build
)
